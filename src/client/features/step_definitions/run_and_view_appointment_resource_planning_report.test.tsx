...
defineFeature(feature, (test) => {
  beforeEach(() => {
    mockAdapter.reset();
    mockAdapter
      .onPost("/api/reports/appointment-resource-planning-summary")
      .reply(200, ReportSummary);
    mockAdapter
      .onPost("/api/reports/appointment-resource-planning/")
      .reply(200, reportDataReturned);
  ...
  test("Run and view appointment resource planning report", ({ given, when, then, and }) => {
    ...
    and(
      "the information will be displayed in time intervals of quarter of an hour, e.g. 09:00, 09:15, 09:30, 09:45, 10:00, 10:15, etc.",
      async () => {
